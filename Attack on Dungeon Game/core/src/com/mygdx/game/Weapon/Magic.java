...
public class Magic extends Weapon{
    ...
    public void generateMagicAnimation() {
        Texture projectile = assetManager.get("player/mage/mage_projectile.png");

        //membuat animasi projectile hadap kanan
        TextureRegion[] frames = MyGdxGame.createAnimationFrames(projectile, 64,32,5, false, true);
        projectileRightAnimation = new Animation<TextureRegion>(0.05f, frames);

        //membuat animasi projectile hadap kiri, sumbu x di-flip
        frames = MyGdxGame.createAnimationFrames(projectile, 64,32,5, true, true);
    ...
    public AttackParticle attack(Vector2 position, Direction direction) {
        ...
        attackParticle.setMaxRadius(500);
        attackParticle.setSpeed(500);
